...
import image1 from "../../assets/images/Captura de Tela 2023-12-06 às 17.03 2.png";
        ...
        <main>
            ...
            <div className="news">
                ...
                <div className="highlight-card">
                    <Image src={image1} alt="Imagem destaque" />
                    <div className="content">
                        <h3>Jul 20, 2022</h3>
                        <h1>Rooftop: benefícios de morar ou comprar apartamento com área de lazer no alto do prédio</h1>
                        <ButtonPrimary text="LEIA MAIS" onClick={() => alert("")} classStyle="#5C635E" />
                    </div>
                </div>
                ...
                <div className="grid-list">
                    {
                        blogCard.map((item: any, i: number) => (
                            <BlogCard key={`blog-card-${i}`} image={image3} dateTime="Jul 20, 2022" title="Conheça o Edifício Central Park da Conrado"
                                      link=""/>
                        ))
                    }
                </div>
