        ...
        <main>
            ...
            <div className="news">
                ...
                <div className="highlight-card">
                    <Image src={placeholder.positive} alt="Imagem destaque" />
                ...
                <div className="grid-list">
                    {
                        blogCard.map((item: any, i: number) => (
                            <BlogCard key={`blog-card-${i}`} image={placeholder.positive} dateTime="Jul 20, 2022" title="Conheça o Edifício Central Park da Conrado"
                                      link=""/>
                        ))
                    }
                </div>
